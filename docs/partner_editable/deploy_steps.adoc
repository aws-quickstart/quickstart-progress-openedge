...
. {https://aws.amazon.com/marketplace/pp/B08CS3KFH5?qid=1594739011658&sr=0-1&ref_=srh_res_product_title}[Open the page for teh Progress OpenEdge RDBMS AMI in AWS Marketplace], and then choose *Continue to Subscribe*.
